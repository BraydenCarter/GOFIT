...
<header>
    ...
    <h3>Advanced Fitness Assessment</h3>
</header>
<nav>
    <display: block>
...
<main>
    <section>
        <form:form>
            ...
            <input type="text" id="benchPress" name="benchPress" value="Bench Press" onfocus="this.value=''"><br>

            <label for="legPress">Leg Press:</label><br>
            <input type="text" id="leghPress" name="legPress" value="Leg Press" onfocus="this.value=''"><br>
            ...
            <label for="stepTest">Step Test:</label><br>
            <input type="text" id="stepTest" name="stepTest" value="Step Test" onfocus="this.value=''"><br>

            <label for="skinFold">Skin Fold:</label><br>
            <input type="text" id="skinFold" name="skinFold" value="Skin Fold" onfocus="this.value=''"><br>

            <label for="sitUps">Sit And Reach:</label><br>
            <input type="text" id="sitNreach" name="sitNreach" value="Sit & Reach" onfocus="this.value=''"><br>

            <label for="Run">1.5 mile Run Time:</label><br>
            <input type="text" id="run" name="run" value="Run Time" onfocus="this.value=''"><br>
            ...
            <input type="radio" id="Alt1" name="fav_language" value="Alt1">
            <label for="alt1">5250-5499 ft</label>
            <input type="radio" id="Alt2" name="fav_language" value="Alt2">
            <label for="alt2">5500-5999 ft</label>
            <input type="radio" id="Alt3" name="fav_language" value="Alt3">
            <label for="alt3">6000-6599 ft</label>
            <input type="radio" id="Alt4" name="fav_language" value="Alt4">
            <label for="alt4">6600+ ft</label><br>




    
            <input type="submit" value="Save Assessment" onclick="calculateAdvancedFA()" />
        </div>
        </form:form>
    </section>
