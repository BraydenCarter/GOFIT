...
<head>
    <meta charset="UTF-8">
    <title>GOFit | Dmeogrpahics</title>
        <style type="text/css">
...
<main>
    <section>
        <form:form>
            <label for="WGInput">Search by Wing:</label><br>
            <input type="text" id="WGInput" name="Input Wing" value="Wing" onfocus="this.value=''"><br>
            <label for="GPInput">Search by Group:</label><br>
            <input type="text" id="GPInput" name="Input Group" value="Group" onfocus="this.value=''"><br>
            <label for="SQInput">Search by Squadron:</label><br>
            <input type="text" id="SQInput" name="Input Squadron" value="Squadron" onfocus="this.value=''"><br>
            <label for="DODInput">Search by Member:</label><br>      
            <input type="text" id="DODInput" name="Input user DOD ID number" value="DOD ID number" onfocus="this.value=''"><br>
        </form:form>
    </section>
</main>
