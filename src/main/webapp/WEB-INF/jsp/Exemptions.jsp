...
<main>
    ...
    <section>
        <form:form action="login" method="post">
            ...
            <div class="container">
                <label for="Exemptions">Exemption Type: </label>
                <input list="logins"placeholder="Select a roll">
                <datalist id="logins" name="logins" >
                    <option value="Medical">
                    <option value="Pregnancy">
                    <option value="Commander">
                    <option value="Deployment/TDY">
                </datalist><br>
              <label for="startDate"><b>DOD ID Number:  </b></label>
              <input type="startDate" placeholder="Start Date" name="startDate"  required><br>
              
              <label for="startDate"><b>Start Date:  </b></label><label for="endDate"><b>End Date:  </b></label>
              <input type="startDate" placeholder="Start Date" name="startDate"  required><br>
              <input type="endDate" placeholder="End Date" name="endDate"  required>
