    ...
    <section>
        ...
        <div class="FAform">
            ...
            <input type="text" id="TestD" name="TestD" value="Test Date" onfocus="this.value=''"><br>
                ...
                <input list="logins">
                <datalist id="logins" value="logins" name="logins" >
                    <option value="92 FSS">
...
<!--Radio dial gender-->
            ...
            <label for="basketballThrowFt">Basketball Throw:</label><br>
            <input type="text" id="basketballThrowFt" name="basketballThrowFt" value="Basketball Throw Feet" onfocus="this.value=''">
            <input type="text" id="basketballThrowIn" name="basketballThrowIn" value="Basketball Throw Inches" onfocus="this.value=''"><br>

            <label for="shuttleRunMinutes">Shuttle Run:</label><br>
            <input type="text" id="shuttleRunMinutes" name="shuttleRunMinutes" value="Shuttle Run Minutes" onfocus="this.value=''">
            <input type="text" id="shuttleRunSeconds" name="shuttleRunSeconds" value="Shuttle Run Seconds" onfocus="this.value=''"><br>

            <label for="pullUps">Pull Ups:</label><label for="hangMinutes" style=padding:110px>Flexed Arm Hang:</label><br>
            <input type="text" id="pullUps" name="pullUps" value="Pull Ups" onfocus="this.value=''">        
<!--flexed arm hang--> <input type="text" id="hangMinutes" name="hangMinutes" value="Flexed Arm Hang Minutes" disabled="disabled" onfocus="this.value=''">
					   <input type="text" id="hangSeconds" name="hangSeconds" value="Flexed Arm Hang Seconds" disabled="disabled" onfocus="this.value=''"><br>

            <label for="runMinutes">1 Mile Run:</label><br>
            <input type="text" id="runMinutes" name="runMinutes" value="1 Mile Run" onfocus="this.value=''">
            <input type="text" id="runSeconds" name="runSeconds" value="1 Mile Run" onfocus="this.value=''"><br>
            ...
            <input type="submit" value="Save Assessment" onclick="calculateOTS()" />
    		</div>
        </form:form>
    </section>
