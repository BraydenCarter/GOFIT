...
<section>
    <form:form>
        ...
        <label for="DODInput">Members DOD ID number:</label><br>
        <input type="text" id="DODInput" name="Input user DOD ID number" value="DOD ID number" onfocus="this.value=''">
        <input type="submit" value="Get Profile"  onclick="getProfile()"/>
    </form:form>
</section>
</main>
</body>