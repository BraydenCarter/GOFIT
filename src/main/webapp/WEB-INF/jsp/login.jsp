...
<head>
    <meta charset="UTF-8">
    <title>GOFit | SOCOM Fitness Test</title>
        <style type="text/css">
...
<!--     <link rel="stylesheet" href="CSS/Styles.css">
    <link href="../src/main/resources/static/Styles/Styles.css" rel="stylesheet" type="text/css">
...
<main>
    <section>
        <form:form action="action_page.php" method="post">
            ...
            <div class="container">
                <label for="logins">Choose a roll: </label>
                <input list="logins"placeholder="Select a roll">
                <datalist id="logins" name="logins" >
                    <option value="Member">
                    <option value="Unit Fitness Program Manager">
                    <option value="Commander">
                    <option value="Fitness Assessment Cell">
                    <option value="Fitness Information Manager">
                </datalist><br>
